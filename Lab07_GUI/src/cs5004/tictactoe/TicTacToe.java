...
/**
 * A single game of Tic Tac Toe, played on a three-by-three grid with two
...
public interface TicTacToe {
   ...
   * @throws IllegalArgumentException if the row and col is off the board
   */
  Player getMarkAt(int r, int c) throws IllegalArgumentException;
