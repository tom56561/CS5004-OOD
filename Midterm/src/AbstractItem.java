 ...
 * the specific items: KitchenItem ClothingItem Book Item
 * 
 * and determine should be moved into the abstract class. Then properly add
 * javadoc to all methods in the abstract class and subclasses. You will need to
 * turn in this file, along with the properly modified version of the other
 * files so that they can make use of all the fields and methods of this
 * AbstractClass.
 * 
 *
 */
