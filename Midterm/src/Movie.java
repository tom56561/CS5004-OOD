/**
 * The Movie interface defines all the supported operations for each movie.
 * 
 * @author eddie
 *
 */
public interface Movie {
  ...
  /**
   * Saves the progress of the video, so that upon the next viewing the video
   ...
   * @param seconds The second, as an int, to move the time to. Must be less than
   *                60.
