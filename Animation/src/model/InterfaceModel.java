...
public interface InterfaceModel {
  ...
  void addShape(String name, ShapeType shapetype, double x, double y, int r1, int g1, int b1, double width,
  ...
  void move(String name, int startTime, int endTime, double startx,
